...
public class SalesforceListenerUtility extends BaseTest
		implements
			ITestListener {
	protected Logger Listenerlog = LogManager.getLogger();
	private static ExtentReportsUtility extentReport = ExtentReportsUtility
			.getInstance();

	@Override
	public void onTestStart(ITestResult result) {
		Listenerlog.info(result.getMethod().getMethodName()
	...
	public void onTestSuccess(ITestResult result) {
		Listenerlog.info(result.getMethod().getMethodName()
				+ ".......test execution completed with success........");
	...
	public void onTestFailure(ITestResult result) {
		Listenerlog.error(result.getMethod().getMethodName()
				+ ".......test execution completed with failure........");
		...
		// class............"+result.getTestClass().getRealClass().getSuperclass().getSuperclass().getDeclaredFields().length);

		/*
		 * WebDriver driver=null;
		 * 
		 * try {
		 * driver=(WebDriver)result.getTestClass().getRealClass().getSuperclass(
		 * ).getDeclaredField("driver").get(result.getInstance());
		 * System.out.println(driver); } catch (IllegalArgumentException e) { //
		...
		//takescreenshot(path);
		extentReport.logTestWithscreenshot(Constants.SCREENSHOTS_DIRECTORY_PATH + filename + ".png");
	...
	public void onStart(ITestContext context) {
		Listenerlog
				.info(context.getName() + " has started....................");
